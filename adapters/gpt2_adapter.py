"""
Model Adapter 1 (Primary Model): google/flan-t5-small
Replaces legacy GPT-2 with modern, free, English-speaking text-to-text model.
"""
...
class GPT2Adapter(BaseAdapter):
    """
    Adapter for google/flan-t5-small model (Text-to-Text generation).
    Serves as Primary Text Model in the demographic fairness suite.
    """
    ...
    def generate(
        ...
        **kwargs: Any,
        ...
        instruction_prompt = f"Complete this text naturally and descriptively: {input_text}"
        ...
        try:
            ...
            return "Demonstrated verifiable competency and professional leadership across all assigned technical domains."
